...
import graphqIcon from "./images/graphql-icon.png";
  ...
  const moveIntoSquareBelow = () => {
    for (let i = 0; i <= 55; i++) {
      ...
      if (isFirstRow && currentColorArrangement[i] === blank) {
        let randomNumber = Math.floor(Math.random() * tecColors.length);
        currentColorArrangement[i] = tecColors[randomNumber];
      }
